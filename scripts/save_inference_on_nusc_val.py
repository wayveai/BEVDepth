...
from bevdepth.exps.nuscenes.base_exp import head_conf, backbone_conf
...
def parse_args():
    ...
    parser.add_argument(
        "result_vis_path", help="Target path to save the visualization result."
    )
...
if __name__ == "__main__":
    ...
    lightning_module = BEVDepthLightningModel(
        data_root=nusc_root, batch_size_per_device=1
    )
