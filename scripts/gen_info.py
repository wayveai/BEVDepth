                ...
                for j in range(max_lidar_sweeps):
                    if sweep_lidar_data['prev'] == '':
                        ...
                        sweep_lidar_info['sample_token'] = sweep_lidar_data[
                            'sample_token']
                        if (sweep_lidar_info['sample_token'] !=
...
def main():
    ...
    mini_trainval_nusc = NuScenes(version='v1.0-mini',
                                  dataroot='./data/nuScenes/',
                                  verbose=True)
    ...
    mmengine.dump(mini_train_infos,
                  './data/nuScenes/nuscenes_infos_mini_train.pkl')
    mmengine.dump(mini_val_infos,
                  './data/nuScenes/nuscenes_infos_mini_val.pkl')
