...
_base_url = 'https://download.openmmlab.com/mmclassification/v0/convnext'
convnext_arch_to_params = {
    'small': {
        'checkpoint':
        f'{_base_url}/convnext-small_32xb128-noema_in1k_20221208-4a618995.pth',
        'feature_channels': [96, 192, 384, 768],
    },
    'base': {
        'checkpoint':
        f'{_base_url}/convnext-base_32xb128-noema_in1k_20221208-f8182678.pth',
